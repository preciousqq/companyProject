...
%>
	<div class="container">
		...
		<div class="row bodyback">
			...
			<div class="col-xs-4 col-sm-3 col-md-2"><img src="../images/logo-4.png"></div>
			...
			<div class="col-xs-8 col-sm-9 col-md-5 text-center"><img class="img01" src="../images/logo-left.png " style="width:90%;"></div>
		...
		<div class="row navback font02">
			...
			<div class="col-sm-4 col-md-2 visible-md-block visible-lg-block" >
				<form action="">
					<input type="search" style="width:150px; margin-left:-50px; margin-top:7px;" placeholder="搜索">
				</form>
			</div>
		</div>
  ...
  <!-- Wrapper for slides -->
	...
	<div class="row rowback">
	 	...
	 	<div class="col-sm-12 col-md-9 text-right"><form action="" method="post" id="form01" name="form01">
	 		...
	 		<input type="submit" value="登&nbsp;&nbsp;录" style="background:rgb(35,54,94); color:#fff;">
	 ...
	 <div class="row text-center font03 h1 bodyback">
	 	<div class="col-md-1"></div>
	 	<div class="col-sm-12 col-md-10">Service&nbsp;&nbsp;Firm &nbsp;&nbsp;服务企业</div>
	 	<div class="col-md-1"></div>
	 </div>
	  <div class="row text-center font05 bodyback">
	 	<div class="col-md-1"></div>
	 	<div class="col-sm-12 col-md-10">西部开源技术中心针对不同企业需求的五大服务体系</div>
	 	<div class="col-md-1"></div>
	 </div>
	  <div class="row text-center bodyback">
	 	<div class="col-md-1"></div>
	 	<div class="col-sm-12 col-md-10">技术支持服务/安全支持服务/维护支持服务/企业培训服务/技术文档服务</div>
	 	<div class="col-md-1"></div>
	 </div>

	 <div class="row fangxiang bodyback">
	 	<div class="col-md-1"></div>
	 	<div class="col-sm-12 col-md-10"><img src="../images/h-1-comp.png" alt="..."><img src="../images/h-2-comp.png" alt="..."><img src="../images/h-3-comp.png" alt="..."><img src="../images/h-4-comp.png" alt="..."></div>
	 	<div class="col-md-1"></div>
	 </div>
...
<% 
 ...
 %> 
      ...
      <tr>
     	<td style="width:83%;padding-left:5px;"><img style="margin-right:10px;" src="../images/more.png"><a href="<%=ne01.getId() %>" style="color:#000;"><%=ne01.getBiaoti() %></a></td>
     	<td style="width:17%"><%=new SimpleDateFormat("yyyy-MM-dd").format(ne01.getNdate()) %></td>
...
<% 
 ...
 %> 
      ...
      <tr>
     	<td style="width:83%;padding-left:5px;"><img style="margin-right:10px;" src="../images/more.png"><a href="<%=ne02.getId() %>" style="color:#000;"><%=ne02.getBiaoti() %></a></td>
...
<% 
 ...
 %> 
      ...
      <tr>
     	<td style="width:83%;padding-left:5px;"><img style="margin-right:10px;" src="../images/more.png"><a href="<%=ne03.getId() %>" style="color:#000;"><%=ne03.getBiaoti() %></a></td>
...
%>
	 	...
	 	<div class="row text-center font03 h1 bodyback">
	 	<div class="col-md-1"></div>
	 	<div class="col-sm-10 col-md-10">Qualification&nbsp;&nbsp;企业资质</div>
	 	<div class="col-md-1"></div>
	 </div>
	  <div class="row text-center font05 bodyback">
	 	<div class="col-md-1"></div>
	 	<div class="col-sm-12 col-md-10">完善的企业资质是服务质量的最佳保障</div>
	 	<div class="col-md-1"></div>
	 </div>
	  <div class="row text-center bodyback">
	 	<div class="col-md-1"></div>
	 	<div class="col-sm-12 col-md-10">营业执照 / 资质证书 / 资格证书 / 文明企业/ 培训资格证书</div>
	 	<div class="col-md-1"></div>
	 </div>
	<div class="row bodyback">
	 	<div class="col-md-1"></div>
	 	...
	 	<div class="students">
	 		...
	 		<div class="student"><img src="../images/main_wrapper-1-comp.png" alt="..."></div>
	 		<div class="student"><img src="../images/main_wrapper-2-comp.png" alt="..."></div>
	 		<div class="student"><img src="../images/main_wrapper-3-comp.png" alt="..."></div>
	 		<div class="student"><img src="../images/main_wrapper-4-comp.png" alt="..."></div>
	 ...
	 <div class="row">
	 	<div class="col-sm-12 col-md-12" style="padding: 0px;">
	 		<img src="../images/empbottom.gif" alt="..." style="width:100%; margin-top:-12px;">
	 	</div>
	 </div>
