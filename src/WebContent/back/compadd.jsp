...
%>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-2"></div>
			<div class="col-sm-2">
				<h4 class="text-center">公司项目添加</h4>
			</div>
			<div class="col-sm-2"></div>
			<div class="col-sm-2"></div>
			<div class="col-sm-1"></div>
		...
		<form action="letcomp" method="post">

		<div class="row">
			<div class="col-sm-1"></div>
			<div class="col-sm-2"></div>
			<div class="col-sm-2 text-right">公司名称：</div>
			<div class="col-sm-2 text-left"><input type="text" name="cname">
			</div>
			<div class="col-sm-2"></div>
			<div class="col-sm-1"></div>
		</div>
		<div class="row">
			...
			<div class="col-sm-2 text-left"><input type="text" name="xiangmu">
		    </div>
			<div class="col-sm-2"></div>
			<div class="col-sm-1"></div>
		</div>
		...
		<div class="row">
			...
			<div class="col-sm-2 text-left"><textarea rows="5" cols="50" name="neirong"></textarea>
		    </div>
			<div class="col-sm-2"></div>
			<div class="col-sm-1"></div>
		</div>
		<div class="row">
			...
			<div class="col-sm-2 text-left"><input type="text" name="cadmin">
		    </div>
			<div class="col-sm-2"></div>
			<div class="col-sm-1"></div>
		</div>
		<div class="row">
			...
			<div class="col-sm-2 text-left"><input type="text" name="cpdate"  value="<%=datetime %>"  readonly>
		    </div>
			<div class="col-sm-2"></div>
			<div class="col-sm-1"></div>
		</div>
